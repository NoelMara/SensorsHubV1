...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    ...
    {{-- Form --}}
    <form method="POST" action="{{ route('administrator.content.update', ['products', $product->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                    class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 outline-none focus:border-emerald-500 transition text-sm resize-none leading-relaxed @error('description') !border-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="price" id="price" step="0.01" required
                        ...
                        class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-gray-900 dark:text-white outline-none focus:border-emerald-500 transition text-sm tabular-nums @error('price') !border-red-500 @enderror">
            ...
            <div>
                <label class="block text-xs font-medium uppercase tracking-[0.15em] text-gray-500 dark:text-gray-400 mb-2">
                    Product image <span class="text-gray-400 dark:text-gray-600 normal-case tracking-normal">(leave empty to keep current)</span>
                </label>
