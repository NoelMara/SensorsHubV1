...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    ...
    <div class="mb-12">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
            Update this assessment for {{ $class->name }}.
        </p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                    ...
                    placeholder="Brief description of the assessment...">{{ old('description', $assessment->description) }}</textarea>
            ...
            <div>
                ...
                <textarea name="instructions" id="instructions" rows="5"
                    ...
                    placeholder="Step-by-step instructions for students...">{{ old('instructions', $assessment->instructions) }}</textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="points" id="points" required min="1"
                        value="{{ old('points', $assessment->points) }}"
            ...
            <label for="is_published" class="flex items-start gap-3 border border-gray-200 dark:border-gray-800 rounded-lg p-4 cursor-pointer hover:border-gray-400 dark:hover:border-gray-600 transition">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">Publish this assessment</p>
