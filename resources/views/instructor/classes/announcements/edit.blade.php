...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    ...
    <div class="mb-12">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
            Update this announcement for {{ $class->name }}.
        </p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="8" required
                    ...
                    placeholder="Write the announcement details here...">{{ old('content', $announcement->content) }}</textarea>
            ...
            <label for="is_published" class="flex items-start gap-3 border border-gray-200 dark:border-gray-800 rounded-lg p-4 cursor-pointer hover:border-gray-400 dark:hover:border-gray-600 transition">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">Publish this announcement</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">When checked, students in this class will see it immediately.</p>
                </div>
            </label>
        </div>
