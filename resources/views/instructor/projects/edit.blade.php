...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <a href="{{ route(($prefix ?? 'instructor') . '.projects.index') }}" class="text-primary hover:underline inline-block text-sm mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <form method="POST" action="{{ ($prefix ?? 'instructor') === 'super-admin' ? route('administrator.content.update', ['projects', $project->id]) : route('instructor.projects.update', $project) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mt-6 flex items-center gap-3">
                    ...
                    <a href="{{ route(($prefix ?? 'instructor') . '.projects.index') }}"
