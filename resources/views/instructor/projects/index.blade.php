...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <a href="{{ route('instructor.projects.create') }}" class="px-4 py-2.5 bg-primary text-white rounded-lg hover:bg-blue-600 transition text-sm font-medium flex-shrink-0">
                        ...
                        @foreach($projects as $project)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                ...
                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                    <a href="{{ route('instructor.projects.edit', $project) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-medium text-primary bg-primary/10 hover:bg-primary/20 dark:hover:bg-primary/20 transition mr-1">
