...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
        <a href="{{ $user->isInstructor() ? route('instructor.dashboard') : route('dashboard.index') }}" class="text-primary hover:underline mb-2 inline-block text-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" value="{{ $user->email }}"
                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-600 dark:text-gray-400 text-sm" disabled readonly>
                    </div>
                </div>
