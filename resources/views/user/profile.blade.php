...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    ...
    {{-- Back link --}}
    <a href="{{ $user->isInstructor() ? route('instructor.dashboard') : route('dashboard.index') }}"
                ...
                <div class="text-center sm:text-left flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 flex-wrap justify-center sm:justify-start">
                        <span class="text-[10px] font-medium uppercase tracking-wider
                            {{ $user->isAdministrator() ? 'text-purple-600 dark:text-purple-400' : '' }}
                            {{ $user->isInstructor() ? 'text-blue-600 dark:text-blue-400' : '' }}
                            {{ !$user->isAdministrator() && !$user->isInstructor() && $user->isUser() ? 'text-gray-500 dark:text-gray-400' : '' }}
        ...
        <div class="border border-gray-200 dark:border-gray-800 rounded-lg p-6">
            ...
            <form action="{{ route('dashboard.profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" value="{{ $user->email }}" disabled readonly
                            class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 text-gray-500 dark:text-gray-500 outline-none text-sm cursor-not-allowed">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">PNG, JPG, or GIF up to 2MB.</p>
                </div>
