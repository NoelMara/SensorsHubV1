...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    @if(auth()->user()->isInstructor() || auth()->user()->isAdministrator())
        <a href="{{ route('instructor.classes.modules.index', $class) }}" class="text-primary hover:underline inline-block text-sm mb-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden" 
        ...
        <div class="px-6 py-5">
            <a href="{{ $module->file_path }}" download
               ...
               class="flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition group rounded-lg -mx-2 px-2 py-2">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        ...
                        <span x-show="downloading" class="text-blue-600 dark:text-blue-400 font-medium">Please wait <span x-text="cooldown + 's'"></span></span>
                    </p>
                </div>
