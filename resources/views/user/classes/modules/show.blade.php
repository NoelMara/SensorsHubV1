...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white">{{ $module->title }}</h1>
    </div>

    @if($module->content)
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
        <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Additional Notes</h2>
