...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 dark:text-white mb-2">Edit Class</h1>
        <p class="text-gray-600 dark:text-gray-400">Update class details.</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <form method="POST" action="{{ route('admin.classes.update', $class) }}">
            ...
            <div class="mt-8 flex space-x-4">
                ...
                <a href="{{ route('admin.classes.show', $class) }}" class="flex-1 bg-gray-300 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-6 py-3 rounded-lg text-center hover:bg-gray-400 dark:hover:bg-gray-600 transition">
                    Cancel
                </a>
            </div>
        </form>
