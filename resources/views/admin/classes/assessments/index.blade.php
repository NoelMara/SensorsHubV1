    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.classes.assessments.create', $class) }}" class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition text-sm whitespace-nowrap">
                    <i class="fas fa-plus mr-1"></i> Add Assessment
                </a>
                <a href="{{ route('admin.classes.assessments.import', $class) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition text-sm whitespace-nowrap">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-5">
                    <div class="flex gap-3">
                        ...
                        <div class="flex sm:flex-col items-center gap-0.5 sm:gap-1 flex-shrink-0">
                            <a href="{{ route('admin.classes.assessments.show', [$class, $assessment]) }}" 
                            ...
                            <a href="{{ route('admin.classes.assessments.edit', [$class, $assessment]) }}" 
                               class="p-1.5 rounded-lg text-gray-500 hover:text-primary hover:bg-primary/10 dark:text-gray-400 dark:hover:text-primary dark:hover:bg-primary/10 transition"
                               title="Edit">
                                <i class="fas fa-edit text-sm"></i>
                            </a>
                            <a href="{{ route('admin.classes.assessments.submissions', [$class, $assessment]) }}" 
                               class="p-1.5 rounded-lg text-gray-500 hover:text-primary hover:bg-primary/10 dark:text-gray-400 dark:hover:text-primary dark:hover:bg-primary/10 transition"
                               title="Submissions">
                                <i class="fas fa-users text-sm"></i>
                            </a>
                            <form action="{{ route('admin.classes.assessments.destroy', [$class, $assessment]) }}" method="POST"
