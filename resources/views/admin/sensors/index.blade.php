                        ...
                        @foreach($sensors as $sensor)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                ...
                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                    <a href="{{ route('admin.sensors.edit', $sensor) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-medium text-primary bg-primary/10 hover:bg-primary/20 dark:hover:bg-primary/20 transition mr-1">
                                        <i class="fas fa-pen mr-1"></i> Edit
                                    </a>
                                    <form method="POST" action="{{ route('admin.sensors.destroy', $sensor) }}" class="inline-block" onsubmit="return confirm('Delete?');">
                                        @csrf @method('DELETE')
