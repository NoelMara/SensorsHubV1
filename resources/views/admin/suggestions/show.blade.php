    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
        <div class="p-6 sm:p-8">
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700 flex items-center gap-3">
                ...
                <form method="POST" action="{{ route('admin.suggestions.status', $suggestion) }}" class="flex items-center gap-2">
                    @csrf @method('PUT')
        ...
        <div class="p-6 sm:p-8">
            ...
            @else
                <div class="flex gap-3">
                    ...
                    <form method="POST" action="{{ route('admin.suggestions.comment.store', $suggestion) }}" class="flex-1">
                        @csrf
